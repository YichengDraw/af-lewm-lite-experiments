...
\fcolorbox{accent}{accentlight}{%
  \parbox{\dimexpr\linewidth-2\fboxsep-2\fboxrule\relax}{
    \textbf{Bottom line.} The reliable rerun reports \textbf{5/100} successes for \textbf{AF-LeWM-lite v1}. All models remain weak under the short matched budget, and the Wilson intervals overlap, so the current evidence supports an exploratory ranking rather than a benchmark-level claim.
  }
}
...
\midrule
Baseline LeWM & 18.03 & 9.69 & 0.14731 & 2/50 & 1/50 & 3/100 = 3.0\% \\
AF-LeWM-lite v1 & 18.17 & 13.30 & 0.15033 & 2/50 & 3/50 & 5/100 = 5.0\% \\
AF-LeWM-lite v2 & 18.24 & 14.02 & 0.15139 & 1/50 & 2/50 & 3/100 = 3.0\% \\
\bottomrule
\end{tabular}
\end{table}
...
\midrule
Baseline LeWM & 3/100 = 3.0\% & [1.03\%, 8.45\%] \\
AF-LeWM-lite v1 & 5/100 = 5.0\% & [2.15\%, 11.18\%] \\
AF-LeWM-lite v2 & 3/100 = 3.0\% & [1.03\%, 8.45\%] \\
\bottomrule
\end{tabular}
\end{table}
