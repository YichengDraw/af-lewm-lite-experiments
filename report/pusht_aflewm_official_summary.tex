...
\fcolorbox{accent}{accentlight}{%
  \parbox{\dimexpr\linewidth-2\fboxsep-2\fboxrule\relax}{
    \textbf{Bottom line.} The reliable rerun reports \textbf{9/100} successes for \textbf{AF-LeWM-lite v1}. All models remain weak under the short matched budget, and the Wilson intervals overlap, so the current evidence supports an exploratory ranking rather than a benchmark-level claim.
  }
}
